...
- (NSDictionary *)formatTheme:(NSDictionary *)pListTheme {
  ...
  [theme setObject:[UIColor colorWithHexString:[pListTheme objectForKey:@"bgInnerColor"] andAlpha:opacity] forKey:@"bgInnerColor"];
  [theme setObject:[UIColor colorWithHexString:[pListTheme objectForKey:@"bgOuterColor"] andAlpha:opacity] forKey:@"bgOuterColor"];
  
  opacity = [(NSNumber *)[pListTheme objectForKey:@"outerRingOpacity"] floatValue];
  [theme setObject:[UIColor colorWithHexString:[pListTheme objectForKey:@"outerRingColor"] andAlpha:opacity] forKey:@"outerRingColor"];
  opacity = [(NSNumber *)[pListTheme objectForKey:@"innerRingOpacity"] floatValue];
  [theme setObject:[UIColor colorWithHexString:[pListTheme objectForKey:@"innerRingColor"] andAlpha:opacity] forKey:@"innerRingColor"];
  
  opacity = [(NSNumber *)[pListTheme objectForKey:@"outerOpacity"] floatValue];
  [theme setObject:[UIColor colorWithHexString:[pListTheme objectForKey:@"outerColor"] andAlpha:opacity] forKey:@"outerColor"];
  opacity = [(NSNumber *)[pListTheme objectForKey:@"outerFillOpacity"] floatValue];
  [theme setObject:[UIColor colorWithHexString:[pListTheme objectForKey:@"outerFillColor"] andAlpha:opacity] forKey:@"outerFillColor"];
  
  opacity = [(NSNumber *)[pListTheme objectForKey:@"innerOpacity"] floatValue];
  [theme setObject:[UIColor colorWithHexString:[pListTheme objectForKey:@"innerColor"] andAlpha:opacity] forKey:@"innerColor"];
  opacity = [(NSNumber *)[pListTheme objectForKey:@"innerFillOpacity"] floatValue];
  [theme setObject:[UIColor colorWithHexString:[pListTheme objectForKey:@"innerFillColor"] andAlpha:opacity] forKey:@"innerFillColor"];
  
  opacity = [(NSNumber *)[pListTheme objectForKey:@"centerOpacity"] floatValue];
  [theme setObject:[UIColor colorWithHexString:[pListTheme objectForKey:@"centerColor"] andAlpha:opacity] forKey:@"centerColor"];
  
  [theme setObject:[UIColor colorWithHexString:[pListTheme objectForKey:@"innerHandleColor"] andAlpha:1] forKey:@"innerHandleColor"];
  [theme setObject:[UIColor colorWithHexString:[pListTheme objectForKey:@"outerHandleColor"] andAlpha:1] forKey:@"outerHandleColor"];
